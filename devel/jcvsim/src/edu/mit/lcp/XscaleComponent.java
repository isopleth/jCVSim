...
public class XscaleComponent extends JComponent {
    ...
    private final YscaleComponent _yScale;
    ...
    public XscaleComponent(TraceListModel listModel, int numTicks,
        ...
        traceList.addListDataListener(new ListDataListener() {
            ...
            public void intervalAdded(ListDataEvent e) {
                ...
                double traceMin = t.getXRange().lower;
                double traceMax = t.getXRange().upper;
                if (traceMin < min) {
                    min = traceMin;
                }
                if (traceMax > max) {
    ...
    private class Scale extends JComponent {
        ...
        public Scale(Trace t) {
            ...
            scaleMin = trace.getXRange().lower;
            scaleMax = trace.getXRange().upper;
            ...
            minField.addPropertyChangeListener(VALUE, new PropertyChangeListener() {
                ...
                public void propertyChange(PropertyChangeEvent pce) {
                    ...
                    if (_plotPanel.getMultipleXScales()) {
                        ...
                        for (Trace t : traceList) {
                            t.setXRange(new Range(scaleMin, t.getXRange().upper));
                        }
                    }
                    updateComponent();
                }
            ...
            maxField.addPropertyChangeListener(VALUE, new PropertyChangeListener() {
                ...
                public void propertyChange(PropertyChangeEvent pce) {
                    ...
                    if (_plotPanel.getMultipleXScales()) {
                        ...
                        for (Trace t : traceList) {
                            t.setXRange(new Range(t.getXRange().lower, scaleMax));
                        }
                    }
                    updateComponent();
                }
